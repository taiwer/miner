...
const commandObj = {
  command: function (data) {
    return request({
      url: '/api/v1/ploter_user/command',
      method: 'post',
      data
    })
  },
  ...
  del: function (data) {
    return request({
      url: '/api/v1/ploter_user/delete' + data,
      method: 'delete',
      data
    })
  },
  ...
  get_list_select: function (params) {
    return request({
      url: '/api/v1/ploter_user/list_select',
      method: 'get',
      params
    })
  },
